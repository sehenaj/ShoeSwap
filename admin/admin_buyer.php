...
elseif (isset($_GET['delete'])) {
    ...
    $query = "DELETE FROM user WHERE USERNAME = '$job_reference_number'";
    $conn->query($query);
...
?>
    <br>
<form method="POST" action="admin_buyer.php">
        <label for="searchName">Search by First Name:</label>
        <input type="text" name="searchName" id="searchName">
        <input type="submit" value="Search">
        <label for="searchCity">Search by City Name:</label>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>
                        <form action='admin_buyer.php' method='get' onsubmit='return confirm(\"Are you sure you want to delete ?\");'>
