      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-gradient-nav sticky-top">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item ">
                ...
                </li><li class="cleansing-item active">
...
$query = "SELECT DISTINCT o.order_id, o.user, o.shoes_id, s.brand, s.type, s.seller_name, s.selling_price 
          FROM `order` o 
          JOIN shoes s ON o.shoes_id = s.id 
          WHERE 1=1";

if (!empty($searchUsername)) {
    $query .= " AND o.user LIKE '%$searchUsername%'";
}

else if (!empty($searchSellerName)) {
    $query .= " AND s.seller_name LIKE '%$searchSellerName%'";
}
else if (!empty($searchPrice)) {
    $query .= " AND s.selling_price <= '$searchPrice'";
}
else {
    $query = "SELECT DISTINCT o.order_id,o.user, o.shoes_id,s.brand,s.type, s.seller_name, s.selling_price FROM `order` o JOIN shoes s ON o.shoes_id = s.id;
    ";
